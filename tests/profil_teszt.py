...
try:
    ...
    print("Várakozás a 'Profilra' gombra...")
    profile = driver.find_element(By.CLASS_NAME, "profile-link")
    profile.click()
    print("Kattintottunk a 'Profilra' gombra.")

    time.sleep(3)
    driver.save_screenshot('profil.png')
    time.sleep(3)
